...
## Project Structure
    ...
    ├── testapiautocatalog_126840  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_126840`
...
2. Clone this repo and `cd testapiautocatalog_126840`
